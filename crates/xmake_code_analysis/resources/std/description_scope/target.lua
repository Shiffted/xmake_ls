...
---@field runargs string|string[]? Test run argument string or array
---@field runenvs table? Test run argument string or array
---@field timeout number? Test run argument string or array
...
---
---TODO: document `target.add_csflags`.
---@scope target
---@return any ... -- ToDo
...
---@scope target
---@param tests string|string[] Test case name string or array, such as "test1", "test2"
---@param ... any Other test configuration parameters, optional
---@param options? TargetAddTestsOption
function add_tests(..., options) end
...
---@scope target
---@param script fun(target: Target): nil After build script function, receives target parameter
...
---@scope target
---@param script fun(target: Target): nil After clean script function, receives target parameter
...
---@scope target
---@param script fun(target: Target): nil After install script function, receives target parameter
...
---@scope target
---@param script fun(target: Target): nil After link script function, receives target parameter
...
---@scope target
---@param script fun(target: Target): nil After package script function, receives target parameter
function after_package(script) end

---
---[Open in browser](https://xmake.io/api/description/project-target#after_prepare)
---@scope target
---@param script fun(target: Target): nil After prepare script function, receives target parameter
...
---@scope target
---@param script fun(target: Target): nil After run script function, receives target parameter
...
---@scope target
---@param script fun(target: Target): nil After uninstall script function, receives target parameter
...
---@scope target
---@param script fun(target: Target): nil Before build script function, receives target parameter
...
---@scope target
---@param script fun(target: Target): nil Before clean script function, receives target parameter
...
---@scope target
---@param script fun(target: Target): nil Before install script function, receives target parameter
...
---@scope target
---@param script fun(target: Target): nil Before link script function, receives target parameter
...
---@scope target
---@param script fun(target: Target): nil Before package script function, receives target parameter
function before_package(script) end

---
---[Open in browser](https://xmake.io/api/description/project-target#before_prepare)
---@scope target
---@param script fun(target: Target): nil Before prepare script function, receives target parameter
...
---@scope target
---@param script fun(target: Target): nil Before run script function, receives target parameter
...
---@scope target
---@param script fun(target: Target): nil Before uninstall script function, receives target parameter
...
---@scope target
---@param script fun(target: Target): nil Build script function, receives target parameter
...
---@scope target
---@param script fun(target: Target): nil Clean script function, receives target parameter
function on_clean(script) end

---
---[Open in browser](https://xmake.io/api/description/project-target#on_config)
---@scope target
---@param script fun(target: Target): nil Configuration script function, receives target parameter
function on_config(script) end

---
---[Open in browser](https://xmake.io/api/description/project-target#on_install)
---@scope target
---@param script fun(target: Target): nil Install script function, receives target parameter
...
---@scope target
---@param script fun(target: Target): nil Link script function, receives target parameter
...
---@scope target
---@param script fun(target: Target): nil Load script function, receives target parameter
function on_load(script) end

---
---[Open in browser](https://xmake.io/api/description/project-target#on_package)
---@scope target
---@param script fun(target: Target): nil Package script function, receives target parameter
function on_package(script) end

---
---[Open in browser](https://xmake.io/api/description/project-target#on_prepare)
---@scope target
---@param script function (target, opt) Prepare phase script function, receives target, opt parameters
...
---@scope target
---@param script function (target, jobgraph, sourcebatch, opt) Batch file processing script function, receives target, jobgraph, sourcebatch, opt parameters
...
---@scope target
---@param script fun(target: Target): nil Run script function, receives target parameter
function on_run(script) end

---
---[Open in browser](https://xmake.io/api/description/project-target#on_run)
---@scope target
---@param script fun(target: Target, opt: TargetOnTestOpt): boolean Test script function
function on_test(script) end

---
---[Open in browser](https://xmake.io/api/description/project-target#on_uninstall)
---@scope target
---@param script fun(target: Target): nil Uninstall script function, receives target parameter
